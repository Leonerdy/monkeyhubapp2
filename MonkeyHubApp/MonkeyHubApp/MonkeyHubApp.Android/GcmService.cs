...
namespace MonkeyHubApp.Droid
{
    ...
    [IntentFilter(new string[] { Gcm.Client.Constants.INTENT_FROM_GCM_REGISTRATION_CALLBACK }, Categories =
new string[] { "@PACKAGE_NAME@" })]
    [IntentFilter(new string[] { Gcm.Client.Constants.INTENT_FROM_GCM_LIBRARY_RETRY }, Categories = new
string[] { "@PACKAGE_NAME@" })]
    public class PushHandlerBroadcastReceiver : GcmBroadcastReceiverBase<GcmService>
    {
        public static string[] SENDER_IDS = new string[] { "1021481777664" };
    }
    ...
    public class GcmService : GcmServiceBase
    {
        ...
        MobileServiceClient client = new MobileServiceClient("http://speedservicenotification.azurewebsites.net");
